...
10	0	*	*	*	root	/usr/bin/mysql_cron.sh >>/var/log/limes/syslog 2>&1
...
20	*	*	*	*	root    /etc/init.d/openas-ldap-sync start > /dev/null 2>&1 
37	3	*	*	*	root    /etc/init.d/openas-quarantine-cron restart > /dev/null 2>&1 
*/10	*	*	*	*	root	/usr/bin/check_amavis_phail.sh
*/10	*	*	*	*   root    /usr/bin/virtual_swap_controller.sh >> /var/log/limes/swap_control.log
