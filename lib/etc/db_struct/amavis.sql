...
GRANT ALL ON amavis.* TO 'amavis'@'localhost' IDENTIFIED BY 're2dd3j';

-- confirmation id storage
CREATE TABLE confirmation (
    confirmation_id VARCHAR(12) NOT NULL PRIMARY KEY,
    maddr_id    bigint unsigned NOT NULL
) ENGINE=InnoDB;
...
INSERT INTO policy (policy_name,virus_quarantine_to,spam_quarantine_to,banned_quarantine_to) VALUES ('DEFAULTQON','virus-quarantine','spam-quarantine','banned-quarantine');
INSERT INTO policy (policy_name,virus_quarantine_to,spam_quarantine_to,banned_quarantine_to) VALUES ('DEFAULTQOFF','','','');
...
CREATE TABLE maddr (
  ...
  quarantiny char(1) NOT NULL DEFAULT '0', -- u8 additional field
  confirmation_counter integer unsigned NOT NULL DEFAULT 0, -- u8 additional field
  first_confirmation DATETIME DEFAULT 0, -- u8 additional field
...
CREATE TABLE msgs (
  ...
  time_iso   TIMESTAMP NOT NULL DEFAULT 0,    -- rx_time: ISO8601 UTC ascii time
